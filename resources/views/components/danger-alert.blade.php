...
<div x-cloak x-data="{ alertIsVisible: false }" x-init="setTimeout(() => {
    ...
    class="fixed right-5 bottom-20 ml-[1rem] overflow-hidden rounded-md border border-red-500 bg-white text-neutral-600 dark:bg-neutral-950 dark:text-neutral-300"
    ...
    <div class="flex w-full items-center gap-2 bg-red-500/10 p-4">
        ...
        <div class="ml-2">
            <h3 class="text-sm font-semibold text-red-500">Alert!</h3>
